                ...
                for i in range(2):
                    for j in range(2):
                        ...
                        if button_x <= mouse_x <= button_x + attack_choose_button_width and button_y <= mouse_y <= button_y + attack_choose_button_height:
                            ...
                            if current_attack_choose_button_clicked1 == i * 2 + j:
                                current_attack_choose_button_clicked1 = None
        ...
        for i in player0_numbers:
            for j in range(4):
                try:
                    ...
                    pokemon_attack_images0.append((pokemon_attack_image0, (i, j)))
                    valid_pair = (i, j)
        ...
        for i in player1_numbers:
            for j in range(4):
                try:
                    ...
                    pokemon_attack_images1.append((pokemon_attack_image1, (i, j)))                  
                    valid_pair = (i, j)
                except FileNotFoundError:
...
play_screen('Team Rocket', random.choice(["Aquatic Field", "Infernal Field", "Electric Field"]), [1, 4, 2], [0, 3, 5], None, 0, None, None)